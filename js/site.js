...
const NAV_HTML = `
  <nav id="nav">
    <div class="nav-side">
      ...
      <span class="nav-loc">India&nbsp;</span>
    </div>

    <div class="nav-pill" id="nav-pill">
      <div class="nav-id">
        <a class="nav-avatar" href="/#work" aria-label="Kripal Singh — home">
          <img src="/assets/imgProfilePicture.svg" alt="">
        </a>
      </div>
...
const FOOTER_HTML = `
  <footer class="footer" id="contact">
    ...
    <p class="ft-credit">Designed by Kripal Singh with inspiration @2026</p>
    <nav class="ft-social" aria-label="Social links">
      <a href="http://www.linkedin.com/in/Kripal-singhh/" target="_blank" rel="noopener">LinkedIn</a>
      <a href="https://github.com/CODEMASTERSTACK" target="_blank" rel="noopener">GitHub</a>
    </nav>
  </footer>
`;

const CONTACT_EMAIL = 'kripalsingh.work@gmail.com';
